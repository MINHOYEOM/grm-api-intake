...
│  ├─ data/  (briefs·deltas·library/ 9카탈로그 400건 + library_updates.json 변경 이력·glossary.json 200어 + glossary_cases.json 사례연결 정본(items 152·excluded 48)·guide_content.md·quiz_bank.json 33문항·announcements/ 서비스 업데이트 안내 — 전 링크 실검증 커밋 데이터)  ·  partials/  ·  tests/  (render 골든, trends.expected.html 포함)
├─ translations/
