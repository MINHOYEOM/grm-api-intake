...
| 기준 시스템 버전 | 로컬 `main` `1e8e48d`(6/15 클로즈아웃 — W5/R3 §1.3 트랙1 + toggle 트랙2 머지, **origin 미push**) · 직전 `origin/main` `2dcc714`(K4-1 + P6~P8 머지) — 바이오 1단계·Keystone K1~K3·K4-1·P6~P8 머지 반영 · **Routine 프롬프트 `v16`(Python-scaffold, 현행 — R2 작성결함 동결 포함)** |
