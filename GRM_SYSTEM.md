...
│  ├─ data/  (briefs·deltas·library/ 6카탈로그 185건·glossary.json 145어·guide_content.md·quiz_bank.json — 전 링크 실검증 커밋 데이터)  ·  partials/  ·  tests/  (render 골든, trends.expected.html 포함)
├─ translations/
