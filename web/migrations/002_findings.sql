...
create table if not exists public.findings (
  ...
  taxonomy_version text not null check (taxonomy_version in ('grm-finding-taxonomy/v1', 'grm-finding-taxonomy/v2', 'grm-finding-taxonomy/v3', 'grm-finding-taxonomy/v4', 'grm-finding-taxonomy/v5', 'grm-finding-taxonomy/v6')),
