...
| 문서 메타 | 값 |
|---|---|
| 문서 버전 | `v1.12` (바이오 1단계 활성 — Phase 3 P1 글로벌 3종(ICH·WHO·HC) 라이브 검증 통과·운영 활성·머지. GAP-1(`biotechnological`) 분류 갭 수정으로 82 테스트 green, Source 옵션 ICH·WHO·Health Canada 사전등록) |
| 최종 수정일 | 2026-06-05 |
