...
| 문서 메타 | 값 |
|---|---|
| 문서 버전 | `v1.13` (Keystone M0 구현 — FDA WL 발행 부서 게이트 `_fda_wl_office_gate` + 8 시나리오, 전체 90 테스트 green, LV-15.7b 해소. `feature/keystone-k2` Codex 검토 후 단독 선머지 예정. 직전 v1.12: 바이오 1단계 활성 — ICH·WHO·HC 라이브·운영 활성·머지, GAP-1 수정) |
| 최종 수정일 | 2026-06-05 |
