...
| 문서 메타 | 값 |
|---|---|
| 문서 버전 | `v1.19` (**K3 G4 1차 dry-run 완료 — 결함 2건 발견·해소**: C-1 조용한 유실(WHO Tier2 임의 축약 162건→Processed 배정) → v16 ⛔불건 해소 불변식(조치 4종·DEFERRED 블록·PL-10b 제외, Codex HOLD→GO) · C-2 노이즈 카드(식품 WL 4=게이트 이전 백로그→Skipped 정리·기기 FR Rule 3=신규 갭→`QA_DEVICE_EXCLUDE_TERMS` 복수형+약물 가드 `d31c5b5`, 163 green). 재 dry-run 후 전환 예정. `ENABLE_HANDOFF_V2` 여전히 off. 직전 v1.18: G3 v16 동결) |
| 최종 수정일 | 2026-06-05 |
