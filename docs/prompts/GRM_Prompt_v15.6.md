# GRM Routine Prompt — v15.6.3 (Intake-first cloud routine, daily collection +MFDS)

> v15.5 대비 변경 사항만 본 문서 상단에 정리하고, 이어서 새 채팅에 그대로 붙여넣을 **v15.6.3 완성 프롬프트** 본문을 제공합니다.
...
## B. v15.6.3 완성 프롬프트 (Routine 에 그대로 복사)
...
1줄: "**GRM Weekly Brief** · v15.6.3 Intake-first daily (+MFDS)"
...
<callout icon="ℹ️" color="gray_bg">
	...
	**범례** — Evidence A: 1차 공식문서 직접 확인 · Evidence B: 공식 인덱스/보조 출처 확인 · Evidence C: 보조 출처 기반. Signal High (T3): 우선 검토 · Signal Medium (T2): 학습/참고 · Signal Low (T1): 모니터링.
	GRM Automated Routine v15.6.3 · Intake-first daily mode (+MFDS)
</callout>
규칙:
...
생성 라벨: "생성: Claude (Anthropic) / GRM Automated Routine v15.6.3 Intake-first daily mode (+MFDS)"
