-- 079 — 자가점검 체크리스트의 사례 발췌를 **조항 위치에서** 뜬다 (2026-09-06)
--
-- ## 무엇이 잘못됐나 (실측)
--
...
-- ★성능은 오히려 좋아졌다(실측, 조항 15개·사례 2건): 043 1,645ms → 079 601ms.
...
comment on function public.findings_checklist(text[], integer) is
  ...
  '본문에 없는 행은 사례에서 제외된다(079). security invoker 라 공개 게이트는 RLS(010)가 '
