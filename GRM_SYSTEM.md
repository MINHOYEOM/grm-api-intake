...
| 문서 메타 | 값 |
|---|---|
| 문서 버전 | `v1.15` (Keystone K2+K2.5 완료·origin/main 머지됨 — `card_scaffold.py`(build_card_scaffold+golden)·K2-prep raw fetch·handoff v2(`ENABLE_HANDOFF_V2` 기본 off, 운영 무영향)·K2.5 scaffold 활성 소스 전 유형 16종 확장(Evidence A⟺quote 정합), 전체 134 green. 다음 K3/K4. 직전 v1.14: K2 B~D 머지) |
| 최종 수정일 | 2026-06-05 |
