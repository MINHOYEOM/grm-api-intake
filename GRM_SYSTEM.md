...
│  ├─ templates/  (landing·archive·brief·findings·trends·**checklist**·firm·**inspector**·me·admin·base·library·library_catalog·guide·glossary·**glossary_term**·quiz)
...
│  ├─ data/  (briefs·deltas·library/ 11카탈로그 502건 + library_updates.json 변경 이력·glossary.json 226어 + glossary_cases.json 사례연결 정본(items 177·excluded 49)·guide_content.md·quiz_bank.json 33문항·announcements/ 서비스 업데이트 안내 — 전 링크 실검증 커밋 데이터)  ·  partials/  ·  tests/  (render 골든, trends.expected.html 포함)
├─ translations/
