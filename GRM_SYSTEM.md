...
│  ├─ data/  (briefs·deltas·library/ 8카탈로그 271건·glossary.json 200어·guide_content.md·quiz_bank.json 33문항·announcements/ 서비스 업데이트 안내 — 전 링크 실검증 커밋 데이터)  ·  partials/  ·  tests/  (render 골든, trends.expected.html 포함)
├─ translations/
